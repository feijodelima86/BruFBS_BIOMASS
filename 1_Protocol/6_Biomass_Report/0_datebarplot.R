...
axis.Date(1, at=seq(as.Date("2020/01/01"), max(a[,1])+6, "1 week"), las=1, font.axis=2, cex.axis=1.5, format="%d-%b")
axis(side = 2, at = c(0, 15, 30, 45, 60), las=1, font.axis=1, cex.axis=1.75)
