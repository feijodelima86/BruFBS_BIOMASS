...
alldata <- data.frame(read_csv("2_Incremental/3_Integration/INTEGRATED_SITENAMES.csv"))
...
#axis.Date(1, at=seq(as.Date("2020/6/29"), max(a[,1])+6, "3 weeks"), las=1, font.axis=2, cex.axis=1.5, format="%d-%b")
axis(side = 4, at = c(0, 15, 30, 45, 60), las=1, font.axis=1, cex.axis=1.75)
...
arrows(a[,1]-0, a[,2], a[,1], a[,2]+a[,3], length=0.1, angle=90, code=2, lwd=2,col="black")
